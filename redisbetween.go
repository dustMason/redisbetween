...
func proxies(c *config.Config, log *zap.Logger) (proxies []*proxy.Proxy, err error) {
	...
	for _, u := range c.Upstreams {
		p, err := proxy.NewProxy(log, s, c, u.Label, u.UpstreamConfigHost, u.Database, u.MinPoolSize, u.MaxPoolSize, u.ReadTimeout, u.WriteTimeout, u.CachePrefixes, u.CacheSizeMB, u.CacheTTLSeconds, u.Readonly)
		if err != nil {
			return nil, err
		}
